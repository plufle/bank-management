...
def login():
    ...
    welcome = Label(login_window, text="                     Welcome to Online Bank                     ",
                    font=('sans-serif', 40),bg='#669bbc',fg='#432818')
    ...
    welcome = Label(login_window, text="   Login   ", font=('sans-serif', 40),bg='#669bbc',fg='#432818')
    welcome.grid(column=1, row=1, columnspan=2)

    spaces = Label(login_window, text="             ", font=('sans-serif', 40),bg='#669bbc')
    spaces.grid(column=0, row=1)

    userid_label = Label(login_window, text="   User ID   ", font=('sans-serif', 30),bg='#669bbc',fg='#e9edc9')
    ...
    pass_label = Label(login_window, text="Password   ", font=('sans-serif', 30),bg='#669bbc',fg='#e9edc9')
