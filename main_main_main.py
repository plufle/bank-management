...
def login():
    ...
    login_window.configure(bg='#005f73')

    welcome = Label(login_window, text="                     Welcome to Online Bank                     ",
                    font=('sans-serif', 40),bg='#005f73',fg='#e9edc9')
    welcome.grid(column=0, row=0, columnspan=6)

    spaces = Label(login_window, text="           ", font=('sans-serif', 40),bg='#005f73')
    spaces.grid(column=0, row=1)

    welcome = Label(login_window, text="   Login   ", font=('sans-serif', 40),bg='#005f73',fg='#e9edc9')
    welcome.grid(column=1, row=1, columnspan=2)

    spaces = Label(login_window, text="             ", font=('sans-serif', 40),bg='#005f73')
    spaces.grid(column=0, row=1)

    userid_label = Label(login_window, text="   User ID   ", font=('sans-serif', 30),bg='#005f73',fg='#e9edc9')
    ...
    pass_label = Label(login_window, text="Password   ", font=('sans-serif', 30),bg='#005f73',fg='#e9edc9')
    ...
    frame_admin = LabelFrame(login_window, text='Administrator', font=('sans-serif', 20),bg='#005f73',fg='#e9edc9')
    ...
    frame_new = LabelFrame(login_window, text='New Account', font=('sans-serif', 20), padx=5, pady=5,bg='#005f73',fg='#e9edc9')
